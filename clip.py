...
# 创建记过保存目录
folder = os.path.split(audio_path)[0] + "5_voice"
...
for index in range(len(not_silence_ranges)):
    ...
    json_dict2["StartPosition"] = new_start_position - new.duration_seconds / 5
    json_dict2["EndPosition"] = new_end_position + new.duration_seconds / 5
